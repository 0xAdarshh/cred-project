...
public class GeocodeService {
    ...
    public geodata getgeocode(String query) {
	    ...
	    if (names.size() == 0) {		//Check if Cache is available if yes get data from API and store it in Cache for future API calls

		RestTemplate restTemplate = new RestTemplate();
		String tempquery = query.replaceAll(",","+");   //Call the Google GeoCode RestAPI 
